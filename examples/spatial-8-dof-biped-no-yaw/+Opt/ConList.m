...
obj.StepWidth.Function = Function('f', {rbm.States.q.sym}, {rbm.BodyPositions{11,2}(2)});
...
obj.StepLength.Function = Function('f', {rbm.States.q.sym}, {rbm.BodyPositions{11,2}(1)});
obj.StepLength.LowerBound = 0.05;
obj.StepLength.UpperBound = 0.3;


% step height (m)
obj.StepHeight.Name = 'Step height';      
obj.StepHeight.Bool = true;
obj.StepHeight.Function = Function('f', {rbm.States.q.sym}, {rbm.BodyPositions{11,2}(3)});
...
obj.ForwardWalkingSpeed.LowerBound = 0.80;      
obj.ForwardWalkingSpeed.UpperBound = 0.80;
...
obj.SwingFootHeight.Function = Function('f', {rbm.States.q.sym}, {rbm.BodyPositions{11,2}(3)});
...
obj.GroundClearance.Function = Function('f', {rbm.States.q.sym}, {rbm.BodyPositions{11,2}(3)});
...
obj.StanceFootInitialPosition.Function = Function('f', {rbm.States.q.sym}, {rbm.BodyPositions{3,1}});
...
obj.StanceFootInitialVelocity.Function = Function('f', {rbm.States.q.sym, rbm.States.dq.sym}, {rbm.BodyVelocities{3,1}});
...
obj.SwingFootVerticalImpactVelocity.Function = Function('f', {rbm.States.q.sym, rbm.States.dq.sym}, {rbm.BodyVelocities{11,2}(3)});
...
obj.SwingFootLateralImpactVelocity.Function = Function('f', {rbm.States.q.sym, rbm.States.dq.sym}, {rbm.BodyVelocities{11,2}(2)});
...
obj.SwingFootForwardImpactVelocity.Function = Function('f', {rbm.States.q.sym, rbm.States.dq.sym}, {rbm.BodyVelocities{11,2}(1)});
...
obj.FootInterference.Function = Function('f', {rbm.States.q.sym}, {rbm.BodyPositions{11,2}(2) - rbm.BodyPositions{3,1}(2)});
...
% absolute torso 
obj.TorsoAngles.Name = 'Absolute torso angles';
obj.TorsoAngles.Bool = true;
obj.TorsoAngles.Function = Function('f', {rbm.States.q.sym}, {[rbm.States.q.sym(4)+rbm.States.q.sym(8); rbm.States.q.sym(5)+rbm.States.q.sym(6)+rbm.States.q.sym(7)]});
obj.TorsoAngles.LowerBound = [-0.01*ones(1, ncp); 0*ones(1, ncp)];
obj.TorsoAngles.UpperBound = [0.01*ones(1, ncp); 0.5*ones(1, ncp)];



% velocity bounds
rbm.States.dq.LowerBound = -20*ones(11,ncp);
rbm.States.dq.UpperBound = 20*ones(11,ncp);

% acceleration bounds
rbm.States.ddq.LowerBound = -100*ones(11,ncp);
rbm.States.ddq.UpperBound = 100*ones(11,ncp);
...
% position bounds
rbm.States.q.LowerBound = -pi*ones(11,ncp);
rbm.States.q.UpperBound = pi*ones(11,ncp);


rbm.States.q.LowerBound(7,:) = -pi/4*ones(1,ncp);
%rbm.States.q.LowerBound(10,:) = -pi/4*ones(1,ncp);

rbm.States.q.UpperBound(7,:) = pi/4*ones(1,ncp);
%rbm.States.q.UpperBound(10,:) = pi/4*ones(1,ncp);


rbm.States.q.LowerBound(6,:) = -pi/2*ones(1,ncp);
rbm.States.q.UpperBound(6,:) = -pi/20*ones(1,ncp);


rbm.States.q.LowerBound(11,:) = pi/20*ones(1,ncp);
rbm.States.q.UpperBound(11,:) = pi/2*ones(1,ncp);
