%% LOAD MODEL & DERIVE DYNAMICS

clear ; clc ; close all

% must run from PROSIM-root folder
PROSIM_addpath('casadi');

cd Spatial_5_link_biped

%{
    dynamics: 'hybrid', 'continuous'
    symbolic: 'matlab', 'casadi'
%}
[rbm] = ld_model(...
    
    {'model',@Model.spatial_5_link},...
    {'dynamics','hybrid'},...
    {'symbolic','casadi'});
...
% struct containing the solution data
data = Optim.extract_data( sol , problem , nlp , rbm , casadi , seed );
