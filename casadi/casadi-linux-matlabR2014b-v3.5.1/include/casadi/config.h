...
#define CASADI_COMPILER_FLAGS " -std=c++11 -pthread -fPIC -fvisibility=hidden -fvisibility-inlines-hidden -Wall -Wextra -Wno-unused-parameter -Wno-sign-compare -Wno-attributes  "  // NOLINT(whitespace/line_length)
